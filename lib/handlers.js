...
handlers._items.get = function(data,callback){
	var items = [
		{"item_code" : 1,"item_name" : "Margherita","item_description" : "Features tomatoes, sliced mozzarella, basil, and extra virgin olive oil."},
		{"item_code" : 2,"item_name" : "Tikka Chicken pizza","item_description" : "Chicken tikka flavour pizza from India"},
		{"item_code" : 3,"item_name" : "Mexicana","item_description" : "tomato sauce, mozzarella, various recipes with minced beef, jalapeños, sweet corn, onion, spicy sauce and other hot ingredients"},
		{"item_code" : 4,"item_name" : "Peperoni","item_description" : "tomato sauce, mozzarella, peperoni"},
		{"item_code" : 5,"item_name" : "Vegetariana","item_description" : "tomato sauce, mozzarella, mushrooms, onion, (artichoke), sweet corn, green peppers,"}
	];
	var token_id = typeof(data.headers.token_id) == "string" ? data.headers.token_id : false;
	if(token_id){
