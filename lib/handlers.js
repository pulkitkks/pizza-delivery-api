															...
															_data.update("users",email,userData,function(err){
																if(!err){
																	_data.delete("carts",cart_id,function(err){
																		if(!err){
																			//Create Mail Body
																			var subject = "Order#ID : " + order_id;
																			var body = "Name : " + userData.name + "\n" + "Address : " + userData.streetAddress + "\n" + "Total Amount Paid : " + order_total + "\n";
																			items.forEach(function(i){
																				body += "Item Name : " + i.item_name + "\n" + "Size : " + i["size"] + "\n" + "Quantity : " + i.quantity + "\n" + "Item Total : " + i.item_total + "\n";
																			});
																			helpers.sendMailGun(email,subject,body,function(err){
																				if(!err){
																					console.log(body);
